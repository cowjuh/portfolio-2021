    ...
    <BodyContainer>
      ...
      <CaseStudy dividerText='MORE' summary={summary}>
        <TextContainer>
          ...
          <p>
            At a glance, the interface is almost monochromatic, but it hides its true colours behind
            its interactions. I felt that this mirrors our stream of consciousness in that we can
            bring color to our thoughts with the right words.
          </p>
        ...
        <TextContainer>
          ...
          <p>
            Thanks to PWA's (Progressive Web App) and the ability to add any webpage to your phone's
            home screen, I was able to easily build a platform independent interface. All it took
            was some media queries and a hamburger menu, of course, to have a responsive web and
            mobile app deployed!
          </p>
